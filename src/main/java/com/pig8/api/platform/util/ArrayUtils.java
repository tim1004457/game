...
public class ArrayUtils {
     ...
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue,
                               boolean isCircle) {
     ...
     */
    public static long getNext(long[] sourceArray, long value, long defaultValue,
                               boolean isCircle) {
        if (sourceArray.length == 0) {
            throw new IllegalArgumentException(
                    "The length of source array must be greater than 0.");
     ...
     * @return
     */
    public static final int getSize(List list) {
    ...
    public static final <T> T getItem(List<T> list, int pos) {
